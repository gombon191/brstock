		...
		<br><br>
								...
								<div class="container">
																...
																<table class="table table-striped table-hover">
														          ...
														          <th> <div align="center">ประเภทสินค้า</th>
														          <th> <div align="center">ขนาด</th>
														          <th> <div align="center">สี</th>
																			<th> <div align="center">ราคา</th>
																			<th> <div align="center">จำนวนคงเหลือ</th>
																			<th> <div align="center">รายละเอียดสินค้า</th>
																			<th> <div align="center">ภาพสินค้า</th>
														          <th> <div align="center">แก้ไข</th>
																			<th> <div align="center">ลบออก</th>
														        </tr>
																	</thead>
																	<tbody>
																<?php
																$num = 0;
																$sql = "SELECT products.*, categories.cat_name FROM products left join categories on products.cat_id = categories.cat_id WHERE 1 ";
																...
																?>
									 								   ...
									 								   <td class="text-left"><?=$row["color"];?></td>
																		 ...
																		 <td><img src="../images/imgupload/<?=$row["img"];?>" width="150" onclick="onClick(this)" class="w3-hover-opacity"></td>
									 								   <td align="center"><a href="editpro.php?pro_id=<?=$row["pro_id"];?>" class="btn btn-info"><span class="glyphicon glyphicon-pencil"></span></a></td>
									 									 <td align="center">
									 								<a href="JavaScript:if(confirm('Confirm Delete?') == true){window.location='delepro.php?pro_id=<?=$row["pro_id"];?>';}" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span></a>
									 								 </tr>
																<?php
																		}
																}
