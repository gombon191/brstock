				...
				<ul class="nav nav-list">
					...
					<li class="">
						<a href="gallery.html">
							...
							<span class="menu-text"> ตัวอย่างสินค้า </span>
						</a>
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form action="insertcat.php" name="addcategories" method="post">

									<div class="form-group">
										<label for="cat_id">
											รหัสประเภทสินค้า :
										</label>
										<input type="text" class="form-control" id="txtcat_id" placeholder="ใสชื่อสินค้า" name="txtcat_id">
									</div>
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" id="txtcat_name" placeholder="ใสชื่อสินค้าเช่น เสื้อ สายคล้อง" name="txtcat_name">
									</div>
